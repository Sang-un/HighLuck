...
public class PostsService {
    ...
    @Transactional(readOnly = true) // transaction 범위는 유지하며 조회기능만 남겨두어 조회속도가 개선됭
